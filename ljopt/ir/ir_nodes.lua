...
local ir_node_LT = require('ljopt.ir.LT')
...
local ir_node_ULT = require('ljopt.ir.ULT')
local ir_node_UGE = require('ljopt.ir.UGE')
local ir_node_UGT = require('ljopt.ir.UGT')
