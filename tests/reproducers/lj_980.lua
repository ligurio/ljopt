...
assert(result, 9, 'TNEW load forwarding')
...
assert(result, 9, 'TNEW load forwarding, aliased table')
...
assert(result, 8, 'TDUP load forwarding different types')
...
-- Checked for assertion guard, on the last iteration we get
-- the value on initializatoin.
assert(result, 8, 'TDUP load forwarding different types, aliased table')
...
-- Checked for assertion guard, on the last iteration we get
-- the value on initializatoin.
assert(result, '8', 'TDUP load forwarding same type, different values')
