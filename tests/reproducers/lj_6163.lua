...
assert(not r, 'math.min fails with no args')

filler()
r, _ = pcall(function() max() end)
assert(false == r, 'math.max fails with no args')
...
-- expected: 1 1 1 1
assert(samevalues(result), 'math.min: reassoc_dup')
...
-- expected: 1 1 1 1
assert(samevalues(result), 'math.max: reassoc_dup')
...
assert(samevalues(result), 'math.min: comm_dup_minmax')
...
-- See also https://github.com/LuaJIT/LuaJIT/issues/957.
-- expected: nan nan nan nan
assert(samevalues(result), 'math.max: comm_dup_minmax')
...
assert(samevalues(result), 'math.min: reassoc_minmax_k')
...
assert(samevalues(result), 'math.max: reassoc_minmax_k')
...
-- expected: 1 1 1 1
assert(samevalues(result), 'min-max-case1: reassoc_minmax_left')
...
-- expected: 1 1 1 1
assert(samevalues(result), 'min-max-case2: reassoc_minmax_left')
...
-- expected: 1 1 1 1
assert(samevalues(result), 'max-min-case1: reassoc_minmax_left')
...
-- expected: 1 1 1 1
assert(samevalues(result), 'max-min-case2: reassoc_minmax_left')
...
-- expected: 1 1 1 1
assert(samevalues(result), 'min-max-case1: reassoc_minmax_right')
...
-- See also https://github.com/LuaJIT/LuaJIT/issues/957.
-- expected: nan nan nan nan
assert(samevalues(result), 'min-max-case2: reassoc_minmax_right')
...
-- expected: 1 1 1 1
assert(samevalues(result), 'max-min-case1: reassoc_minmax_right')
...
-- See also https://github.com/LuaJIT/LuaJIT/issues/957.
-- expected: nan nan nan nan
assert(samevalues(result), 'max-min-case2: reassoc_minmax_right')
...
-- expected: 1.1 1.1 1.1 1.1
assert(samevalues(result), 'min: fold_kfold_numarith')
...
-- expected: 1.1 1.1 1.1 1.1
assert(samevalues(result), 'max: fold_kfold_numarith')
